...
const withLayout = Page => {
  ...
  WithLayout.getInitialProps = async context => {
    return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, Page.getInitialProps ? await Page.getInitialProps(context) : {});
  };
...
Index.getInitialProps = async function () {
  const res = await isomorphic_fetch__WEBPACK_IMPORTED_MODULE_2___default()('https://api.tvmaze.com/search/shows?q=batman');
...
module.exports = __webpack_require__(/*! /Users/carlodicelico/Source/hello-next/pages/index.js */"./pages/index.js");
